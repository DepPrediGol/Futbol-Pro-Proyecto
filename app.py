...
st.markdown("""
    <style>
    /* Forzar fondo blanco y letras negras en los menús desplegables para celulares */
...
if len(fechas_futuras) > 0:
    ...
    ahora = datetime.now()
    inicio_partidos = proxima_fecha.replace(hour=8, minute=0)
